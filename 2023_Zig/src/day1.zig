...
pub fn ComputeResult(in_stream: anytype) !void
{
	try ComputeResultInternal(in_stream, false);
}

pub fn ComputeResult_PartB(in_stream: anytype) !void
{
	try ComputeResultInternal(in_stream, true);
}
